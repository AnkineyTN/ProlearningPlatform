...
@AllArgsConstructor
@Entity
@Table(name = "pomodoro_user_favorite_space",
       uniqueConstraints = @UniqueConstraint(columnNames = {"id_user", "id_space"}))
public class PomodoroUserFavoriteSpace extends AbstractEntity {
